...
const ProductManagement = () => {
    ...
    const products = [
        { id: 1, name: 'Premium Cotton Formal Shirt', category: 'Fashion', price: '₹1,699', stock: 45, sales: 128, status: 'Active', image: 'https://theformalclub.in/cdn/shop/files/TealFormalShirt_4.jpg?v=1751886662&width=600' },
        { id: 2, name: 'Smart Watch Series 7', category: 'Electronics', price: '₹4,299', stock: 12, sales: 56, status: 'Active', image: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?w=500&auto=format&fit=crop&q=60' },
        { id: 3, name: 'Wireless Headphones XT', category: 'Electronics', price: '₹1,999', stock: 0, sales: 89, status: 'Out of Stock', image: 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=500&auto=format&fit=crop&q=60' },
        { id: 4, name: 'Leather Sneakers', category: 'Fashion', price: '₹2,899', stock: 24, sales: 34, status: 'Inactive', image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=500&auto=format&fit=crop&q=60' },
    ];
        ...
        <div className="space-y-8 pb-12">
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
                ...
                <div className="flex items-center gap-3 w-full sm:w-auto">
                    <button className="flex-1 sm:flex-none border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 font-bold py-2.5 px-4 rounded-xl flex items-center justify-center gap-2 transition-all cursor-pointer text-sm">
            ...
            <div className="flex items-center justify-between border-b border-gray-200 mt-4 overflow-x-auto scrollbar-hide">
                ...
                <div className="hidden md:flex items-center gap-4 pb-4">
                    ...
                    <button className="flex items-center gap-2 text-sm font-bold text-gray-700 hover:text-blue-600 border-none bg-transparent cursor-pointer">
            ...
            <div className="flex flex-col md:flex-row gap-4 justify-between items-center">
                ...
                <div className="flex items-center gap-3 w-full md:w-auto">
                    <button className="p-2.5 bg-white border border-gray-200 rounded-xl hover:bg-gray-50 text-gray-600 transition-all border-none cursor-pointer">
