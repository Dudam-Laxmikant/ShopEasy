...
const OrderProcessing = () => {
    ...
    const [orders, setOrders] = useState([
        ...
        { id: '#ORD-9015', customer: 'Robert Zane', items: 1, total: '₹2,100', date: 'Feb 19, 2026', time: '02:30 PM', status: 'Cancelled', address: 'Anna Nagar, Chennai, TN', email: 'robert.z@example.com', phone: '+91 32109 87654', payment: 'UPI', products: [{ name: 'Linen Trousers', price: '₹2,100', qty: 1 }] },
            ...
            <div className="space-y-4">
                {filteredOrders.length > 0 ? (
                    filteredOrders.map((order) => (
                        <div key={order.id} className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden hover:shadow-md transition-all group animate-in fade-in duration-500">
                    ...
                    >
                        ...
                        <div className="p-8 overflow-y-auto max-h-[70vh] space-y-8 scrollbar-hide">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-start gap-3 p-4 bg-orange-50/50 border border-orange-100/50 rounded-2xl">
                                    ...
                                    <p className="text-sm text-gray-700 leading-relaxed font-medium">
                                        ...
                                        <br />
                                        <span className="text-gray-400 text-xs mt-1 block">Gate #4, Landmark near post office.</span>
                                    </p>
                                </div>
                            </div>
                        ...
                        <div className="p-8 border-t border-gray-100 bg-gray-50/50 flex gap-4">
                            {['New', 'In Process', 'Shipped'].includes(selectedOrder.status) && (
                                <button
                                    ...
                                    className="flex-1 py-4 bg-gray-900 text-white rounded-2xl text-sm font-bold hover:bg-black transition-all shadow-lg hover:shadow-black/20 flex items-center justify-center gap-2 border-none cursor-pointer"
                                >
                            ...
                            <button className="flex-1 py-4 bg-white border border-gray-200 text-gray-700 rounded-2xl text-sm font-bold hover:bg-gray-50 transition-all flex items-center justify-center gap-2 cursor-pointer shadow-sm">
                                <Printer className="w-5 h-5 text-purple-500" /> Download Invoice
                            </button>
                        </div>
                    </div>
                </div>
